...
class DOMParser_to_json:
    ...
    def setDriver(self):
        ...
        opts.set_preference("gfx.direct2d.disabled", True)
        opts.set_preference("gfx.direct3d11.enabled", False)
        ...
        opts.set_preference("network.http.keep-alive.timeout", 600)
        opts.set_preference("network.http.max-persistent-connections-per-proxy", 256)
        opts.set_preference("network.http.max-connections-per-server", 64)
        opts.set_preference("network.http.max-persistent-connections-per-server", 32)
        opts.set_preference("webdriver.load.strategy", "eager")
